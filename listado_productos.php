...
<html>
    ...
    <script type="application/ld+json">
        ...
        <!--<header align="center" style="font-weight: bold; font-size:large">Listado de productos</header><br>-->
        
        <script src="./js/jquery-3.3.1.min.js"></script>
        <script>
            function modProd(id) {
                window.location = "./modificaProductos.php?id="+id;
            }
    ...
    <p align="center" style="font-weight: bold; font-size:large">Listado de productos</p> 
    <p align="center">Para agregar un nuevo producto presione <a href="./formProductos.php">aquí</a></p>
        <table align="center">
            <tr>
                <th>ID</th>
                <th>Nombre</th>
                ...
                if (mysqli_num_rows($res) > 0) {
                    while ($producto = mysqli_fetch_assoc($res)) {
                        ...
                        <tr id=\"producto".$producto['ID_PRODUCTO']."\">
                            <td style=\"width: 25px;\">".$producto['ID_PRODUCTO']."</td>
                            <td>".$producto['NOMBRE_PRODUCTO']."</td>
                            <td>".$producto['CATEGORIA']."</td>
                            <td style=\"width: 55px;\"><img src=\"./images/".$producto['IMAGEN']."\" style=\"width:50px; height:50px;\"></td>
                            <td>".$producto['MATERIAL']."</td>
                            <td>".$producto['COLOR']."</td>
                            <td>$".number_format($producto["PRECIO"], 2, '.', ',')."</td>
                            <td>".$producto['STOCK']."</td>
                            <td style=\"width: 200px;\">".$producto['DESCRIPCION']."</td>
                            <td><button onclick=\"deleteProd(".$producto['ID_PRODUCTO'].");\">Eliminar</button></td>
                            <td><button onclick=\"modProd(".$producto['ID_PRODUCTO'].");\">Modificar</button></td>
                        </tr>
                        ";
                    }
                }
