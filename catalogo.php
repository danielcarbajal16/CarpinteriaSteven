    ...
    <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
      <div>
        ...
        <ul id="display-inline-block-example">
          <?php 
            $sql = "SELECT * FROM PRODUCTO WHERE CATEGORIA = 'Sillas' AND STOCK > 0";
      ...
      <div>
        ...
        <ul id="display-inline-block-example">
        <?php 
            $sql = "SELECT * FROM PRODUCTO WHERE CATEGORIA = 'Mesas' AND STOCK > 0";
            $res = mysqli_query($con, $sql);
            if (mysqli_num_rows($res) > 0) {
              while ($producto = mysqli_fetch_assoc($res)) {
                echo "
      ...
      <div>
        ...
        <ul id="display-inline-block-example">
        <?php 
            $sql = "SELECT * FROM PRODUCTO WHERE CATEGORIA = 'Recamaras' AND STOCK > 0";
            $res = mysqli_query($con, $sql);
            if (mysqli_num_rows($res) > 0) {
              while ($producto = mysqli_fetch_assoc($res)) {
                echo "
      ...
      <div>
        ...
        <ul id="display-inline-block-example">
        <?php 
            $sql = "SELECT * FROM PRODUCTO WHERE CATEGORIA = 'Ropero' AND STOCK > 0";
            $res = mysqli_query($con, $sql);
            if (mysqli_num_rows($res) > 0) {
              while ($producto = mysqli_fetch_assoc($res)) {
                echo "
      ...
      <div>
        ...
        <ul id="display-inline-block-example">
        <?php 
            $sql = "SELECT * FROM PRODUCTO WHERE CATEGORIA = 'Jardineria' AND STOCK > 0";
            $res = mysqli_query($con, $sql);
            if (mysqli_num_rows($res) > 0) {
              while ($producto = mysqli_fetch_assoc($res)) {
                echo "
      ...
      <div>
        ...
        <ul id="display-inline-block-example">
        <?php 
            $sql = "SELECT * FROM PRODUCTO WHERE CATEGORIA = 'Cortineros' AND STOCK > 0";
            $res = mysqli_query($con, $sql);
            if (mysqli_num_rows($res) > 0) {
              while ($producto = mysqli_fetch_assoc($res)) {
                echo "
