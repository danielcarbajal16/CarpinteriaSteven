...
<head>
  ...
  <script>
    ...
    function agrega(id) {
      window.location = "./agregar_carrito.php?id=" + id + "&cantidad=1";
    }
...
<body data-home-page="https://website303650.nicepage.io/House-Repair-Services-1.html?version=44e14f81-1fe2-4e50-b81b-c7970ca063ac" data-home-page-title="House Repair Services 1" class="u-body">
              ...
              <li>
                <a>
                  <select name="Categorias" label="Categorias" id="Categorias" onchange="categoria();">
                    ...
                    <option value="Mesas" <?php if ($categoria == 'Mesas') echo "selected"; ?>>Mesas</option>
                    <option value="Sillas" <?php if ($categoria == 'Sillas') echo "selected"; ?>>Sillas</option>
                    <option value="Recamaras" <?php if ($categoria == 'Recamaras') echo "selected"; ?>>Recamaras</option>
                    <option value="Ropero" <?php if ($categoria == 'Ropero') echo "selected"; ?>>Roperos</option>
                    <option value="Jardineria" <?php if ($categoria == 'Jardineria') echo "selected"; ?>>Jardinería</option>
                    <option value="Cortineros" <?php if ($categoria == 'Cortineros') echo "selected"; ?>>Cortineros</option>
                  </select>
                </a>
              </li>
  ...
  <section class="u-align-center u-clearfix u-grey-5 u-section-2" id="carousel_4ff3">
    <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
      <div>
        <a><?php echo $categoria ?></a><br>
        <ul id="display-inline-block-example">
          <?php
          $sql = "SELECT * FROM PRODUCTO WHERE CATEGORIA = '$categoria' AND STOCK > 0";
          ...
          if ($rows > 0) {
            while ($producto = mysqli_fetch_assoc($res)) {
              echo "
                    <li>
                      <a href=\"./detalle_producto.php?id=" . $producto['ID_PRODUCTO'] . "\"><img src=\"./images/" . $producto['IMAGEN'] . "\" width=\"150\" height=\"150\"></a><br>
                      <a>" . $producto["NOMBRE_PRODUCTO"] . "</a><br>
                      <a>$" . number_format($producto["PRECIO"], 2, '.', ',') . "</a><br>
                      <a>" . $producto["MATERIAL"] . "</a><br>
                      <button onclick=\"agrega(" . $producto['ID_PRODUCTO'] . ")\">Comprar</button>
                    </li>";
            }
          } else {
            echo "No hay productos en esta categoría aún";
          }
          ?>
        </ul>
      </div>
